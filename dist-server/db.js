...
export const repo = {
    ...
    createSurvey(input) {
        ...
        db.prepare(`INSERT INTO surveys (id, title, description, type, status, identity_mode, slug, access_code, pages_json, questions_json, created_at, updated_at)
       VALUES (@id, @title, @description, @type, @status, @identity_mode, @slug, @access_code, @pages_json, @questions_json, @created_at, @updated_at)`).run({
            ...payload,
